...
public class DeepSeekClient {
  ...
  private void streamMockResponse(
      List<ChatMessage> messages, Consumer<String> onToken, Runnable onComplete) {
    new Thread(
            () -> {
              try {
                ...
                if (lastUserMessage.toLowerCase().contains("table")) {
                  ...
                  response =
                      "I received your message: \""
                          + lastUserMessage
                          + "\".\n\n"
                          + "I can demonstrate **Markdown** rendering capabilities. Try asking for"
                          + " a *table*, *code*, or *task list*!";
                }
