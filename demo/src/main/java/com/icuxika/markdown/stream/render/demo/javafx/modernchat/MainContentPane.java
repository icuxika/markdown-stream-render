...
public class MainContentPane extends BorderPane {
  ...
  private void startStreamingResponse(String userMessage) {
    ...
    currentStreamParser = StreamMarkdownParser.builder().renderer(currentStreamRenderer).build();
              ...
              Platform.runLater(
                  () -> {
                    ...
                    chatHistories
                        ...
                        .addMessage("assistant", accumulated.toString());
                  });
            });
  ...
  private String generateMockResponse(String userMessage) {
    ...
    if (lowerMessage.contains("hello") || lowerMessage.contains("hi")) {
      ...
      return "Thank you for your message! I understand you're asking about: \""
          + userMessage
          + "\"\n\n"
