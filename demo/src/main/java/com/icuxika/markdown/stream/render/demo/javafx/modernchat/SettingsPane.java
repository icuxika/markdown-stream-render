...
public class SettingsPane extends BorderPane {
  ...
  private VBox createNavigationList() {
    ...
    String[] categories = {
      "General", "Appearance", "AI Models", "Keyboard Shortcuts", "Data & Privacy", "About"
    };
  ...
  private void showGeneralSettings() {
    ...
    HBox fontSizeRow =
        createSettingRow(
            ...
            () -> {
              ...
              slider
                  .valueProperty()
                  .addListener((obs, old, val) -> valueLabel.setText(val.intValue() + "px"));
    ...
    section
        .getChildren()
        .addAll(themeRow, languageRow, fontSizeRow, soundRow, autoScrollRow, timestampsRow);
    ...
    HBox bubbleStyleRow =
        createSettingRow(
            ...
            () -> {
              ...
              bubblesBtn
                  .getStyleClass()
                  .addAll("settings-style-button", "settings-style-button-selected");

              Button flatBtn = new Button("Flat");
              flatBtn.getStyleClass().add("settings-style-button");

              bubblesBtn.setOnAction(
                  e -> {
    ...
    return createSettingRow(
        ...
        () -> {
          ...
          slider
              .valueProperty()
              .addListener(
                  (obs, old, val) -> valueLabel.setText(String.format("%.1f", val.doubleValue())));
  ...
  private VBox createModelCard(String name, String status, boolean connected, boolean isDefault) {
    ...
    statusLabel
        .getStyleClass()
        .add(connected ? "model-status-connected" : "model-status-disconnected");
