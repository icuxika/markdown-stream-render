    ...
    container
        ...
        .addAll(
            createNotificationItem(
                "❤️", "John Doe", "liked your post", "Just launched a new feature! 🚀", true),
            createNotificationItem(
                "🔄", "Jane Smith", "retweeted your post", "Working on exciting projects!", false),
            ...
            createNotificationItem(
                "🔄", "Code Ninja", "retweeted your post", "Hot take: Simplicity wins!", true));

    return container;
  }

  private HBox createNotificationItem(
      String icon, String user, String action, String preview, boolean unread) {
