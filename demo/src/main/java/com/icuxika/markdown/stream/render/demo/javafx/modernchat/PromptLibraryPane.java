...
public class PromptLibraryPane extends BorderPane {
  ...
  private void loadSamplePrompts() {
    PromptItem[] prompts = {
      new PromptItem(
          ...
          "Analyze code for best practices, potential bugs, and improvement suggestions",
          "Development",
          true),
      new PromptItem(
          "Blog Post Writer",
          "Generate engaging blog content on any topic with SEO optimization",
          "Writing",
          false),
      new PromptItem(
          "Data Analysis Expert",
          "Help interpret and visualize data with clear explanations",
          "Analysis",
          true),
      new PromptItem(
          "Meeting Summary",
          "Condense meeting notes into key points and action items",
          "General",
          false),
      new PromptItem(
          "Debug Helper",
          "Identify and fix code errors with step-by-step solutions",
          "Development",
          true),
      new PromptItem(
          "Email Composer", "Draft professional emails for any business context", "Writing", false),
      new PromptItem(
          "API Documentation",
  ...
  private static class PromptCard extends VBox {
    ...
    private void initializeUI() {
      ...
      favoriteIcon.setOnMouseClicked(
          e -> {
    ...
    void setOnUse(Runnable callback) {
      ((Button) ((HBox) this.getChildren().get(3)).getChildren().get(0))
          .setOnAction(e -> callback.run());
    }
  }
}
