...
public class VirtualJavaFxStreamRenderer implements StreamMarkdownTypingRenderer {
  ...
  public VirtualJavaFxStreamRenderer(
      ObservableList<Node> historyItems, VBox activeContainer, Runnable requestScrollToBottom) {
    this(historyItems, activeContainer, requestScrollToBottom, null);
  }

  public VirtualJavaFxStreamRenderer(
      ObservableList<Node> historyItems,
      VBox activeContainer,
