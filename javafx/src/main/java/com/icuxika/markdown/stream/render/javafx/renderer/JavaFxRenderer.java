 ...
 * </p>
 * <p>
 * 默认会自动加载核心渲染器以及 Admonition 和 Math 扩展渲染器。 样式文件位于
 * {@code /com/icuxika/markdown/stream/render/javafx/css/} 目录下。
 * </p>
 */
public class JavaFxRenderer implements MarkdownRenderer, JavaFxNodeRendererContext {
  ...
  /**
   * Clear the renderer state and output. Useful when reusing the renderer for
   * virtualization cells.
   */
  public void clear() {
