...
public class CoreJavaFxNodeRendererTest extends BaseTest {
  ...
  public void testRenderBulletList() throws InterruptedException {
    runAndWait(
        () -> {
          ...
          com.icuxika.markdown.stream.render.core.ast.BulletList list =
              new com.icuxika.markdown.stream.render.core.ast.BulletList();
          com.icuxika.markdown.stream.render.core.ast.ListItem item =
              new com.icuxika.markdown.stream.render.core.ast.ListItem();
  ...
  public void testRenderCodeBlock() throws InterruptedException {
    runAndWait(
        () -> {
          ...
          // Mock AST: CodeBlock
          com.icuxika.markdown.stream.render.core.ast.CodeBlock codeBlock =
              new com.icuxika.markdown.stream.render.core.ast.CodeBlock(
  ...
  public void testRenderInlineStyles() throws InterruptedException {
    runAndWait(
        () -> {
          ...
          Paragraph p = new Paragraph();
          com.icuxika.markdown.stream.render.core.ast.StrongEmphasis strong =
              new com.icuxika.markdown.stream.render.core.ast.StrongEmphasis();
  ...
  public void testRenderBlockQuote() throws InterruptedException {
    runAndWait(
        () -> {
          ...
          com.icuxika.markdown.stream.render.core.ast.BlockQuote quote =
              new com.icuxika.markdown.stream.render.core.ast.BlockQuote();
          Paragraph p = new Paragraph();
  ...
  public void testRenderTable() throws InterruptedException {
    runAndWait(
        () -> {
          ...
          com.icuxika.markdown.stream.render.core.ast.Table table =
              new com.icuxika.markdown.stream.render.core.ast.Table();
          com.icuxika.markdown.stream.render.core.ast.TableHead head =
              new com.icuxika.markdown.stream.render.core.ast.TableHead();
          com.icuxika.markdown.stream.render.core.ast.TableRow row =
              new com.icuxika.markdown.stream.render.core.ast.TableRow();
          com.icuxika.markdown.stream.render.core.ast.TableCell cell =
              new com.icuxika.markdown.stream.render.core.ast.TableCell();
          cell.setHeader(true);
  ...
  private void initRenderer() {
    ...
    context =
        new JavaFxNodeRendererContext() {
          private final java.util.Stack<javafx.scene.layout.Pane> containers =
              new java.util.Stack<>();
          ...
          public void registerNode(
              com.icuxika.markdown.stream.render.core.ast.Node astNode, Node fxNode) {
            // No-op for test
          }
