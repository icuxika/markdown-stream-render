...
public class TypewriterIncrementalParsingTest {
  ...
  public void previewUpdatesWhileLeafOpen() {
    ...
    StreamMarkdownTypingRenderer renderer =
        new StreamMarkdownTypingRenderer() {
          @Override
  ...
  public void previewUpdatesInsideListItemAcrossLines() {
    ...
    boolean sawFirst =
        previews.stream().anyMatch(p -> p.contains("Long line: This is a very very very"));
    boolean sawSecond =
        previews.stream()
            .anyMatch(
                p -> p.contains("Long line: This is a very very very\nvery very very long line."));
    assertTrue(sawFirst);
