...
/**
 * Markdown Renderer Interface. Inherits from {@link Visitor}, generating target format (e.g. HTML, JavaFX Node) by
...
public interface MarkdownRenderer extends Visitor {
     ...
     *
     * @return rendered object (type depends on implementation, e.g. String or javafx.scene.Node)
     */
    Object getResult();
}
